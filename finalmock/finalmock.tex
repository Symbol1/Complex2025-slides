...
\no \raisebox{-2cm}{\includegraphics[width=4cm]{div.png}}
\yes \raisebox{-2cm}{\includegraphics[width=4cm]{curl.png}}
...
\raisebox{-2cm}{\includegraphics[width=4cm]{z.png}}
\raisebox{-2cm}{\includegraphics[width=4cm]{mo.png}}
...
\raisebox{-2cm}{\includegraphics[width=4cm]{white.png}}

\Problem
$\exp(2000 + i) = ?.??701060846160 \cdot 10^{868}
+ ?.??590052030137 \cdot 10^{868} i$.
...
\raisebox{-2cm}{\includegraphics[width=4cm]{spiral.png}}
...
For $h(x) = \sin(x) / x^4$, the principal value is $0.???259575107558$.
